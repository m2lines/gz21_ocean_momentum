...
from src.gz_ocean_momentum.data.datasets import (
...
from src.gz_ocean_momentum.train.utils import (
    DEVICE_TYPE,
...
# Not sure this is neccessary? And it's called as a type?
...
with open(
    os.path.join(data_location, MODELS_DIRECTORY, "nn_architecture.txt"), "w"
) as f:
