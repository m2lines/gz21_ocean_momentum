...
client = MlflowClient()
run_id = run["run_id"]
predictions_file = client.download_artifacts(run_id, "model_output/predictions.npy")
...
mse_time_series = np.mean(np.power(predictions - targets, 2), axis=(1, 2, 3))
plt.figure()
