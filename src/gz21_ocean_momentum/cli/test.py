...
# module description (displayed in CLI via --help)
_cli_desc = """
Predict forcings for input ocean velocity with specific settings, and optional
fine-tuning.
"""

p = configargparse.ArgParser(description=_cli_desc)
p.add("--config-file", is_config_file=True, help="config file path")
p.add("--epochs", type=int, default=0)
